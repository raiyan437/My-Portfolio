...
- **Assets & Media**: Resume PDF (`public/assets/SQA_Raiyan_Uddin_CV.pdf`), project detail screenshots, topbar logo favicon, custom QA SVGs. Unused duplicate files cleaned up.
...
```bash
git add .
git commit -m "chore: remove unused duplicate assets and update docs"
